...
const Hero = () => {
  ...
  return (
    <div className="container 2xl:px-20 mx-auto my-10">
      <div className="bg-gradient-to-r from-blue-800 to-blue-300 text-white py-16 text-center mx-2 rounded-xl">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-medium mb-4">
          {" "}
          Over 100000 Jobs ro apply
        </h2>
      ...
      <div className="border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex">
        <div className="justify-center gap-10 flex flex-wrap">
